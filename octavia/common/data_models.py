...
class LoadBalancer(BaseDataModel):
    ...
    def __init__(self, id=None, tenant_id=None, name=None, description=None,
                 ...
                 provisioning_status=None, enabled=None, host_id=None,
                 colocation_hint=None, apolocation_hint=None, listeners=None):
        self.id = id
        self.tenant_id = tenant_id
        self.name = name
        self.description = description
        ...
        self.provisiong_status = provisioning_status
        self.enabled = enabled
        self.host_id = host_id
        self.colocation_hint = colocation_hint
        self.apolocation_hint = apolocation_hint
