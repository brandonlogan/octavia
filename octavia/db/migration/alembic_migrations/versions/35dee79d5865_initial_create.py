...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(u'vip_subnet_id', sa.String(36), nullable=True),
        sa.Column(u'vip_address', sa.String(36), nullable=True),
        sa.Column(u'vip_floating_ip_id', sa.String(36), nullable=True),
        sa.Column(u'vip_floating_ip_network_id', sa.String(36), nullable=True),
